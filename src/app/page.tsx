...
export default function Home() {
  return (
    <div className='min-h-screen bg-gradient-to-b from-white to-neutral-100 dark:from-neutral-950 dark:to-neutral-800'>
      <BackgroundBeamsWithCollision>
        <div className='flex flex-col items-center justify-center h-full max-w-3xl mx-auto text-center text-balance gap-8'>
          <h1 className='text-neutral-100 text-7xl font-semibold'>
