...
export default function ProjectTimeline({ project }: { project: IProject }) {
  return (
    <div className='bg-tartiary p-3 md:p-5 lg:p-8 rounded-md border border-border grid grid-cols-4 gap-4 my-12'>
      <TimelinePart icon={Users} title='Timeline' content={project.client} />
